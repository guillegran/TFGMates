...
\varLambda^{k-1}(J\times U) \arrow{d}{\mathrm{d}} && \varLambda^{k-1}(U)\arrow{d}{\mathrm{d}}\\
\varLambda^{k}(J\times U)\arrow{rru}{h}\arrow{d}{\mathrm{d}} && \varLambda^{k}(U)\arrow{d}{\mathrm{d}}\\
\varLambda^{k+1}(J\times U)\arrow{rru}{h}\arrow{d}{\mathrm{d}} && \varLambda^{k+1}(U)\arrow{d}{\mathrm{d}}\\
\vdots && \vdots
\end{tikzcd}
    \end{center}
...
&	= \int_0^1 (\mathrm{d}\circ i_{\frac{\partial}{\partial t}} + i_{\frac{\partial}{\partial t}}\circ \mathrm{d})(\omega)_{(t,x)}dt\\
	...
	\begin{center}
	  \begin{tikzcd}
	    \varLambda^k(U)	    \arrow{r}{r^*}\arrow{rd}[anchor=north,rotate=-30]{\tilde{h}} & \varLambda^k(J\times U)\arrow{d}[anchor=west]{h} \\ 
	     &\varLambda^{k-1}(U).
	   \end{tikzcd}
	 \end{center}
