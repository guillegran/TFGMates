...
\RR^n	\arrow{r}{\varphi^F_\bullet(x)}\arrow{d}{ } & M_a\arrow{ld}[anchor=north,rotate=30]{\theta^x} \\ 
	 ...
	 \begin{center}
	   \begin{tikzcd}
	     && && \TT^n \\
	     \\
	     U \arrow{dd}{F|_U} && \mathscr{D}_i \arrow[hook]{ll} \arrow{ddrr}{F|_\mathscr{D}} \arrow{rr}{\Phi^i} \arrow{rruu}{\theta^i_b} && D_i \times \TT^n \arrow{uu}{\mathrm{proj}_2} \arrow{dd}{\mathrm{proj}_1}	     \\ 
	     \\
