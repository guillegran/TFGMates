...
Sea $(M,H)$ un sistema integrable en el sentido de Liouville con $F_1,\dots,F_n$ las funciones en involución.
 ...
 Podemos tomar unas coordenadas $w=(w_1,\dots w_n)$ en $M_a$ de manera que existen unas velocidades constantes $v(a)=(v_1(a),\dots,v_n(a))$ tales que $\dot w (t)=v$. Como consecuencia, las ecuaciones de Hamilton del sistema con $x$ como condición inicial son integrables por cuadraturas.
...
\begin{center}
 ...
 \begin{equation*}
   ...
   \end{cases}
 \end{equation*}
 Esto prueba la tercera parte del teorema.
