...
\]
de donde concluimos que $\dd \beta =0$. Por el lema de Poincaré, en $\RR^n$ todas las formas cerradas son exactas, luego existe $\gamma$ en $\RR^n$ tal que $\beta= \dd \gamma$.
