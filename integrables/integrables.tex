...
\begin{center}
 ...
 \begin{equation*}
   ...
   \end{cases}
 \end{equation*}
 Si tomamos ahora un entorno $U$ de $x$ simplemente conexo podemos ver que localmente las funciones $(F,w)$ cumplen las relaciones de conmutación canónicas,
 \begin{equation*}
 ...
 \end{equation*}
 Además, por hipótesis $\pois{F_i}{F_j}=0$ y $\pois{w_i}{w_j}=0$. Por tanto, localmente $\omega(X^{F_j},X^{w_k})=\delta_{jk}$ y $\omega(X^{F_i},X^{F_j})=\omega(X^{w_i},X^{w_j})=0$. Esto nos permite hallar una carta de Darboux en $x$ siguiendo estos campos, en la que las ecuaciones de Hamilton quedan integradas por cuadraturas.
